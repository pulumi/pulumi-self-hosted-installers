...
IT DOES NOT WORK YET - just storing in the repo so it is not lost.

Status: you get a glimpse into how the author works ...
* 01: Have a project that stands up a network, buckets, sql, gke
* 02: This project will stand up the pulumi service (console and api [and migration]) At this point it's just a bunch of code to test 01 at this point. 
* Other folders are just copies to use as references.


# Self-Hosted Pulumi on GCP
