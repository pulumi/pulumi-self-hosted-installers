        ...
        const opensearch = new k8s.helm.v3.Chart("opensearch", {
            ...
            values: {
                ...
                config: args.enableTLS ? {
                    // Transport layer TLS
                    "plugins.security.ssl.transport.pemcert_filepath": "/usr/share/opensearch/config/transport-crt.pem",
                    "plugins.security.ssl.transport.pemkey_filepath": "/usr/share/opensearch/config/transport-key.pem",
                    "plugins.security.ssl.transport.pemtrustedcas_filepath": "/usr/share/opensearch/config/transport-ca.pem",
                    "plugins.security.ssl.transport.enforce_hostname_verification": "false",
                    "plugins.security.ssl.transport.resolve_hostname": "false",
                    
                    // HTTP layer TLS
                    "plugins.security.ssl.http.enabled": "true",
                    "plugins.security.ssl.http.pemcert_filepath": "/usr/share/opensearch/config/http-crt.pem",
                    "plugins.security.ssl.http.pemkey_filepath": "/usr/share/opensearch/config/http-key.pem",
                    "plugins.security.ssl.http.pemtrustedcas_filepath": "/usr/share/opensearch/config/http-ca.pem",
