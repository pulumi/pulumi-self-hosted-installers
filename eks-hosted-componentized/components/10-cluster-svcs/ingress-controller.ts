...
export function createAlbIngressController(name: string, args: AlbIngressControllerOptions, parent?: pulumi.ComponentResource) {
  ...
  }, {provider: args.k8sprovider, parent});
