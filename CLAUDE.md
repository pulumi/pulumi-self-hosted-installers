...
1. **Syntax Validation**: Use `npm run validate:diagrams` before committing
...
4. **Color Coding**: Use consistent CSS classes for service types:
...
5. **Structure**: Organize diagrams with subgraphs for logical groupings
6. **Dependencies**: Show both stack-level and resource-level dependencies
7. **Data Flow**: Use dotted lines for data/network flow patterns