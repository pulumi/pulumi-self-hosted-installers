...
# ./quickstart-docker-compose/scripts/run-ee.sh -f ./quickstart-docker-compose/all-in-one/docker-compose.yml -f ./quickstart-docker-compose/all-in-one/docker-compose.override.yml
