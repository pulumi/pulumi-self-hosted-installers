    ...
    constructor(name: string, args: OpensearchArgs, opts?: pulumi.ComponentResourceOptions) {
        ...
        const domain = new aws.opensearch.Domain("pulumi-res-search", {
            ...
            clusterConfig: {
                ...
                zoneAwarenessEnabled: args.subnetIds.length > 1,
                zoneAwarenessConfig: {
                    availabilityZoneCount: args.subnetIds.length,
                },
            },
            ebsOptions: {
                ebsEnabled: true,
...
function validateNetworkConfiguration(subnetIds: string[], instanceCount: number) {
